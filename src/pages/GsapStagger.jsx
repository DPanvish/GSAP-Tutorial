...
const GsapStagger = () => {
  ...
  // gsap stagger is implemented here (try modifying the values)
  // stagger is a property which allows multiple elements of same class
  // or id to animate one by one
  useGSAP(() => {
    gsap.to(".stagger-box", {
      y: 250,
      rotation: 360,
