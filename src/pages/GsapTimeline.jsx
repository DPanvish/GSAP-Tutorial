...
const GsapTimeline = () => {
  ...
  // gsap.timeline is implemented here (try modifying the values)
  ...
  useGSAP(() => {
    ...
    // the below timeline.to continues from above state
    timeline.to("#yellow-box", {
      y: 150,
      scale: 2,
      rotation: 360,
  ...
  return (
    <main>
      ...
      <div className="mt-20 space-y-10">
        ...
        {/* Here we have implemented play and pause using timeline */}
        <button onClick={() => {
          if(timeline.paused()){
            timeline.play();
          }else{
