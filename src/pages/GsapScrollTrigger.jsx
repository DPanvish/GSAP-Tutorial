...
const GsapScrollTrigger = () => {
  ...
  // gsap scroll trigger is implemented here (Try modifying it)
  // ScrollTrigger is a plugin so we need to import it and register
  // Trigger the animation in scroll
  const scrollRef = useRef();
  // scrolleRef is used in the boxes div
    ...
    boxes.forEach((box) => {
      gsap.to(box, {
        ...
        scrollTrigger: {
          ...
          // scrub is used for smooth animations
          scrub: true,
        },
        ease: 'power1.inOut'
      })
    })
    // We have passed scrollRef as dependency to identify the reference to the element
  }, {scope: scrollRef})
